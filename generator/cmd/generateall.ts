...
const argsConfig = yargs
  ...
  .option('skip-root-schema-update', { type: 'boolean', desc: 'If true, avoid updating root schemas' })
  .option('skip-for-testing', { type: 'boolean', desc: 'If true, skip running the actual logic to simplify testing' })
...
executeSynchronous(async () => {
    ...
    if (!args['skip-root-schema-update']) {
