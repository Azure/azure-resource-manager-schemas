...
import { findRecursive, findDirRecursive, executeCmd, rmdirRecursive, lowerCaseCompare } from './utils';
import * as constants from './constants';
import chalk from 'chalk';
import { ScopeType, WhitelistResourceConfig, WhitelistConfig } from './models';
...
function schemaRefComparer(schemaRefA: string, schemaRefB: string) {
    ...
    return lowerCaseCompare(splitA[1], splitB[1]) || lowerCaseCompare(splitA[0], splitB[0]);
}
