    ...
    const schemaFilePaths = utilities.getFiles(schemasFolderPath, function (filePath) {
        ...
        if (filePath.endsWith(".json")) {
            ...
            result = (schemaFileName !== "deploymentParameters.json" &&
                ...
                schemaFileName !== "autogeneratedResources.json" &&
                schemaFileName !== "subscriptionDeploymentParameters.json" &&
                schemaFileName !== "subscriptionDeploymentTemplate.json" &&
                schemaFileName !== "managementGroupDeploymentParameters.json" &&
                schemaFileName !== "managementGroupDeploymentTemplate.json" &&
                schemaFileName !== "tenantDeploymentParameters.json" &&
                schemaFileName !== "tenantDeploymentTemplate.json" &&
